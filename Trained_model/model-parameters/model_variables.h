...
const char* ei_classifier_inferencing_categories[] = { "Plastic", "Metal Can", "Paper", "Rotten Fruits", "E-waste", "Water Bottle" };
...
const ei_impulse_t impulse_609202_0 = {
    .project_id = 609202,
    .project_owner = "nischay sharma",
    .project_name = "chsw",
    .impulse_id = 1,
    ...
    .visual_ad_grid_size_x = int((64 / 8) / 2 - 1),
    .visual_ad_grid_size_y = int((64 / 8) / 2 - 1),
...
ei_impulse_handle_t impulse_handle_609202_0 = ei_impulse_handle_t( &impulse_609202_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_609202_0;
